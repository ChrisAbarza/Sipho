...
public class BuscarSeguido extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        URL= met.getBdUrl()+"buscarPorSeguidos.php?seguidor="+profile.getId().toString();
    ...
    private void buscarOfertaSeguidos(String url) {
        ...
        StringRequest stringRequest =  new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(BuscarSeguido.this, "Ops Error 1"+error, Toast.LENGTH_SHORT).show();
